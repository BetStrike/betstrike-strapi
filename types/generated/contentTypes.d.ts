...
export interface ApiAuthAuth extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::auth.auth'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    signin: Schema.Attribute.Component<'auth.sign-in', false> &
      Schema.Attribute.Required;
    signup: Schema.Attribute.Component<'auth.sign-up', false> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGameFaqGameFaq extends Struct.SingleTypeSchema {
  collectionName: 'game_faqs';
  info: {
    description: '';
    displayName: 'Game FAQ';
    pluralName: 'game-faqs';
    singularName: 'game-faq';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    game_shows: Schema.Attribute.Component<'game-faq.game-faq', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    live_casino_games: Schema.Attribute.Component<'game-faq.game-faq', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::game-faq.game-faq'
    >;
    originals: Schema.Attribute.Component<'game-faq.game-faq', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    providers: Schema.Attribute.Component<'game-faq.game-faq', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    slots: Schema.Attribute.Component<'game-faq.game-faq', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGameProviderGameProvider
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faq: Schema.Attribute.Component<'game-faq.game-faq', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiUserVerificationUserVerification
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    verification_level: Schema.Attribute.Component<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::game-faq.game-faq': ApiGameFaqGameFaq;
